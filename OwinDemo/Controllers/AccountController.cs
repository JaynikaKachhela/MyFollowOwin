    ...
    public class AccountController : Controller
    {
        ...
        public void SendMail(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                m.Body = string.Format("Thank you for your registration, please click on the below link to complete your registration: <a href=\"{0}\" title=\"Confirm your email ClickHere\">{0}</a>", Url.Action("Confirm", "Account", new { userId = user.Id, email = user.Email }, Request.Url.Scheme));
                m.IsBodyHtml = true;
        ...
        [AllowAnonymous]
        public async Task<ActionResult> Confirm(string userId, string email)
        {
